...
line2 = geom.line(P1=[l,-h], P2=[l,h], bc_type=bc.stress_bc(), bc_value=0*sig_ext)
line3 = geom.line(P1=[l,h], P2=[-l,h], bc_type=bc.stress_bc(), bc_value=sig_ext*1j)
line4 = geom.line(P1=[-l,h], P2=[-l,-h], bc_type=bc.stress_bc(), bc_value=0*sig_ext)
crack = geom.line(P1=-a, P2=a, bc_type=bc.stress_bc())
